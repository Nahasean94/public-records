...
class NewLogBook extends React.Component {
    ...
    validateInfo(data) {
        let errors = {}
        if (validator.isEmpty(data.car_number)) {
            errors.car_number = 'This field is required'
        }
        if (validator.isEmpty(data.full_names)) {
            errors.full_names = 'This field is required'
        }
        if (validator.isEmpty(data.kra_pin)) {
            errors.kra_pin = 'This field is required'
        }
        if (validator.isEmpty(data.registration_date)) {
        ...
        if (!data.manufacture_year.value) {
            errors.manufacture_year = 'This field is required'
        }
        if (data.car_number.length > 8 || data.car_number.length < 7) {
            errors.car_number = 'Car number plate must be between 7 and 8 characters'
        }
        if (data.car_number.indexOf(" ") !== 3) {
            errors.car_number = 'Car number plate must be in the format KCA 475F or KXJ 745'
        }
        ...
        if (!data.kra_pin.match(/[a-zA-Z0-9]/g)) {
            errors.kra_pin = "KRA Pin can only contain letters and numbers"
        }
        if (Date.parse(data.registration_date) > Date.parse(new Date())) {
                        ...
                        <form onSubmit={this.onSubmit}>
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-9 ">
                                    ...
                                    />
                                    {errors && errors.make &&<div className="alert alert-danger">{errors.make}</div>}
                                </div>
                            </div>
                            {/*<div className="form-group row">*/}
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-9 ">
                                    ...
                                    />
                                    {errors && errors.manufacture_year && <div className="alert alert-danger">{errors.manufacture_year}</div>}
                                </div>
                            </div>
                            {/*<div className="form-group row">*/}
                            ...
                            <div className="form-group row">
                                ...
                                <div className="col-sm-9 ">
                                    ...
                                    />
                                    {errors && errors.color && <div className="alert alert-danger">{errors.color}</div>}
                                </div>
                            </div>
                            <TextFieldGroup
